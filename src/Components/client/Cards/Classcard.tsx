...
const Classcard:React.FC<classdata>=({classData})=> {
  return (
    <div className="flex flex-col  justify-center  mb-4">
                <div className=" flex flex-col w-[800px] h-[130px] md:flex-row md:space-x-5  md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white ">
                  <div className="w-full md:w-1/3 bg-white grid place-items-center">
                    {classData.video && <video src={classData.video} className="rounded-xl h-28 "   />}
                  </div>
