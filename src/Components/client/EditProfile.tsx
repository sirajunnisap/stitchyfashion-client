...
import { updateProfile } from '../../Services/client/userData'
...
const EditProfile: React.FC<EditProfileProps> = ({ isOpen, closeModal,setUser,user }) => {
                ...
                <Form method="POST" className="register-form" id="register-form">
                    <div className="flex -mx-3">
                        <div className="w-1/2 px-3 mb-5">
                            ...
                            id="name" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter Name"/>
                            </div>
                        </div>
                        <div className="w-1/2 px-3 mb-5">
...
//     e.preventDefault();
//     // Handle form submission and profile update here
//     // You can use an API call to update the profile data
...
//       {/* Render EditProfile modal when isModalOpen is true */}
//       {isModalOpen && <EditProfile closeModal={handleModalClose} />}
//     </div>
//   );
// };
