      ...
      <div className="mx-auto max-w-4xl md:flex">
        <div className="mx-auto mb-3 w-full rounded-md bg-white px-8 py-8 shadow-lg shadow-blue-100 md:my-2 md:flex md:w-1/3 md:max-w-none md:flex-col md:px-10 md:py-10">
          <div className="w-full flex-grow">
            ...
            <h3 className="mb-5 text-center text-4xl font-bold">$25<span className="text-sm">/mo</span></h3>
          ...
          <div className="w-full">
            <button className="w-full whitespace-nowrap rounded-md bg-gray-500 px-10 py-2 font-bold text-white transition-colors hover:bg-gray-700">Free Trial</button>
          </div>
        </div>
