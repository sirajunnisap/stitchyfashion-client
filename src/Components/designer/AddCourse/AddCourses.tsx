...
function AddCourses() {
  ...
  const [desicriptionError, setDescriptionError] = useState<string | null>(
    null
  );
  ...
  const handleSubmit: React.FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    if (formData.description.trim() === "") {
      setDescriptionError(
        "description cannot be empty or consist only of spaces."
      );
      return;
    }
  ...
  const generateUrl = async (img: File) => {
    try {
      ...
      const { data } = await axios.post(
        "https://api.cloudinary.com/v1_1/doottwqrx/image/upload",
        datas
      );
                    ...
                    <div className="w-full">
                      ...
                      <div>
                        <div className="form-group">
                          {fileUrl ? (
                            <div
                              className="w-full  p-5 bg-cover flex justify-end"
                                  ...
                                  <div className="text-center">
                                    <label>
                                      ...
                                      <div className="flex flex-auto ml-36 mx-auto -mt-10">
                                        <img
                                          className="has-mask ml-8 object-center"
                                          src="https://img.freepik.com/free-vector/image-upload-concept-landing-page_52683-27130.jpg?size=338&ext=jpg"
                                          alt="image"
                                        />
                                      </div>
                                      <p className="ml-40 pointer-none text-gray-500 ">
